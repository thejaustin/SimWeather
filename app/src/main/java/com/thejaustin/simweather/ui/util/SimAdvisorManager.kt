...
enum class AdvisorMood {
    HAPPY, NEUTRAL, CONCERNED, URGENT
}
...
object SimAdvisorManager {
    ...
    fun getTransportationAdvice(weather: CurrentWeather): AdvisorOpinion {
        ...
        return when {
            condition.contains("snow") || condition.contains("ice") -> AdvisorOpinion(
            ...
            condition.contains("rain") && precip > 10.0 -> AdvisorOpinion(
                advisorName = "Moe Sillan (Transportation)",
