...
object UnitConverter {
    ...
    fun temperature(celsius: Double, units: SettingsPreferences.Units): String {
        return when (units) {
    ...
    fun speed(kph: Double, units: SettingsPreferences.Units): String {
        return when (units) {
    ...
    fun distance(km: Double, units: SettingsPreferences.Units): String {
        return when (units) {
    ...
    fun pressure(mb: Double, units: SettingsPreferences.Units): String {
        return when (units) {
    ...
    fun precipitation(mm: Double, units: SettingsPreferences.Units): String {
        return when (units) {
