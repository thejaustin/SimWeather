...
class WeatherSimulator {
    ...
    private val sunnyWeather = WeatherResponse(
        ...
        current = CurrentWeather(25.0, 77.0, 1, Condition("Sunny", "//cdn.weatherapi.com/weather/64x64/day/113.png", 1000), 5.0, 180, "S", 1012.0, 0.0, 40, 0, 26.0, 79.0, 10.0, 8.0),
    ...
    private val rainyWeather = WeatherResponse(
        ...
        current = CurrentWeather(18.0, 64.0, 1, Condition("Light rain", "//cdn.weatherapi.com/weather/64x64/day/296.png", 1183), 15.0, 220, "SW", 1008.0, 2.5, 80, 75, 17.0, 63.0, 5.0, 4.0),
        forecast = Forecast(listOf()),
    ...
    private val snowyWeather = WeatherResponse(
        ...
        current = CurrentWeather(-2.0, 28.0, 0, Condition("Heavy snow", "//cdn.weatherapi.com/weather/64x64/night/338.png", 1225), 25.0, 300, "WNW", 1002.0, 10.0, 95, 100, -5.0, 23.0, 1.0, 1.0),
        forecast = Forecast(listOf()),
